...
export interface ApiApplyApply extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::apply.apply'> &
      Schema.Attribute.Private;
...
export interface ApiEducationServiceEducationService
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::education-service.education-service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEngineeringServiceEngineeringService
  extends Struct.CollectionTypeSchema {
  collectionName: 'engineering_services';
  info: {
    displayName: 'engineeringService';
    pluralName: 'engineering-services';
    singularName: 'engineering-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::engineering-service.engineering-service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
...
export interface ApiItserviceItservice extends Struct.CollectionTypeSchema {
  collectionName: 'itservices';
  info: {
    displayName: 'Itservice';
    pluralName: 'itservices';
    singularName: 'itservice';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNewsesNewses extends Struct.CollectionTypeSchema {
  collectionName: 'news';
  info: {
    displayName: 'news';
    pluralName: 'news';
...
export interface ApiOpportunityOpportunity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatweoffer: Schema.Attribute.Text;
  };
}
...
export interface ApiPortfolioPortfolio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    LongDescription: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
